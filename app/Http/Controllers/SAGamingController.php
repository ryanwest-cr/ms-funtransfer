...
class SAGamingController extends Controller
{
    ...
    public function PlayerLost(){
        ...
        try {
            ...
            $client_response = ClientRequestHelper::fundTransfer($client_details,abs($amount),$game_details->game_code,$game_details->game_name,$game_transextension,$transaction_check->game_trans_id, 'credit');
            ...
            Helper::saveLog('SA Gaming Success Bet Lost', config('providerlinks.sagaming.pdbid'), json_encode($data), $data_response);
            echo $this->makeArrayXML($data_response);
            return;
