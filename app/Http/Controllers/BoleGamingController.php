			...
			if(!$hashen){
				...
				if($json_data->type == 20){
						...
						{	
			                ...
			                $client_response = ClientRequestHelper::fundTransfer($client_details,abs($pay_amount),$db_game_code,$db_game_name,$check_game_ext->game_trans_id,$game_transextension,$transaction_type);
