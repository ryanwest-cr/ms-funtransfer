...
class TidyController extends Controller
{
	...
	public function gameWin(Request $request){
		...
		$bet_transaction = ProviderHelper::findGameTransaction($existing_bet->game_trans_id, 'game_transaction');
		    ...
		    $game_transextension = ProviderHelper::createGameTransExt($existing_bet->game_trans_id,$transaction_uuid,$transaction_uuid, $amount, 2, $data, $data_response, $requesttosend, $client_response, $data_response);
